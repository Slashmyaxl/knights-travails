// Each index corresponds to a vertex of the chess board, starting from the top-left = 0

// Each value within sub-array corresponds to the adjacent verticies of index = vertex
